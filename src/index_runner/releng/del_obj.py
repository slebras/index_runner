...
from src.utils.re_client import delete_doc, delete_edges
...
def _del_copy_edge(obj_ver_key):
    ...
    delete_edges('ws_copied_from', from_id=from_id)
...
def _del_created_with_method_edge(obj_ver_key):
    ...
    delete_edges('ws_obj_created_with_method', from_id=from_id)
...
def _del_type_vertices(obj_info):
    ...
    delete_doc('ws_type_version', obj_type)
    delete_doc('ws_type', f'{type_module}.{type_name}')
    delete_doc('ws_type_module', type_module)
